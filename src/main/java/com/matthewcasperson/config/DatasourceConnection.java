...
public class DatasourceConnection {
    ...
    private static final String H2_USER = "root";
    private static final String H2_PASSWORD = "Algor@999";
    private static final String H2_DRIVER = "org.h2.Driver";

    /**
     * This is where Tomcat has created our datasource
     */
    private static final String LOOKUP_DATASOURCE_JNDI = "java:/comp/env/jdbc/saiproj";
